"""
Logging configuration for the ZENITHAPPLYAI application.
"""
import os
import logging
...
def configure_logging(app):
    ...
    if not app.debug and not app.testing:
        mail_handler = SMTPHandler(
            ...
            subject='ZENITHAPPLYAI Application Error',
    ...
    # Log startup message
    app.logger.info('ZENITHAPPLYAI application starting', extra={
