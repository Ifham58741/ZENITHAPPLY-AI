#!/usr/bin/env python
"""
Script to create an admin user for the ZENITHAPPLYAI application.
"""
import os
import sys
import argparse
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description='Create an admin user for the ZENITHAPPLYAI application.')
