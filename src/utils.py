...
2. DEFAULT_CHROME_PROFILE_DIR is now absolute (~/.ZENITHAPPLYAI/…) to avoid duplicates
...
DEFAULT_CHROME_PROFILE_DIR = Path.home() / ".ZENITHAPPLYAI" / "chrome_profile" / "default_user"
